...
class Text2ImgService:
    ...
    def create(self, text2img: Text2ImgSession) -> int:
        text2img.id = self.storage_service.insert(
            table_name="text_2_images",
            columns=("iso_created_at", "query", "base64",
                     "base64_seed", "iso_response_received_at"),
            values=(text2img.iso_created_at, text2img.query, text2img.base64,
                    text2img.base64_seed, text2img.iso_response_received_at)
        )
        return text2img.id
