...
class ChatGptService:
    ...
    def start_new_session(self) -> None:
        self.messages = [
            {"role": "system", "content": self.ai_system_initial_context}]
    ...
    def add_from_chat_item(self, chat_item: ChatItem) -> None:
        role = "user" if int(
            chat_item.role) == ChatItemRole.me.value else "assistant"
    ...
    def generate_summary_title(self, question: str, on_success: Callable) -> None:
        UrlRequest(
            ...
            on_success=lambda request, response: on_success(
    ...
    def build_generate_summary_title(self, question: str) -> None:
        messages = [
            {"role": "system", "content": "You are expert at summarizing long questions as small titles."}]
